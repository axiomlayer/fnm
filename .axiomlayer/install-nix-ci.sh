...
temporary_directory=$(mktemp -d "${TMPDIR:-/tmp}/axiom-fnm-nix.XXXXXXXX")
...
# The byte-pinned installer is also the independent authority for the platform
# tarball. Require the digest we copied into promotion.json before execution.
